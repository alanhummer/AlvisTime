                            ...
                            getConfigRemote(orgKeyLocationFile,  function(errRemote, responseRemote) { //Remote get
                                getConfigLocal(function(errLocal, responseLocal) { //Local get
                                    if (errRemote != null) {
                                        ...
                                        if (errLocal != null) {
                                            //Local error also - need fresh key
                                        ...
                                        //We have successfully gotten the orgkey file
                                        if (errLocal != null) {
                                            //Failed, use the one remote one - store it 
